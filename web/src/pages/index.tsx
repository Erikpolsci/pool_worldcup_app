...
import UsersAvatarExamples from '../assets/users-avatars-exemple.png'
    ...
    <div className="max-w-[1124px] h-screen mx-auto gap-28 grid grid-cols-2 items-center" >
      <main>
        ...
        <div className="mt-10 flex items-center gap-2">
          ...
          <Image src={UsersAvatarExamples} alt="Avatar dos usuarios" />
      ...
      <Image src={appPreviewImg} alt="Dois celulares exibindo previa da aplicacao"
        quality={100}
